...
public class ToDoListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		//Try1-LayoutInflater inflater = LayoutInflater.from(mContext);
		//     RelativeLayout itemLayout = (RelativeLayout) inflater.inflate(R.layout.todo_item, null); //try with parent,true
        //Try2-LayoutInflater inflater = (LayoutInflater)mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
